...
"""
该执行文件主要用于训练基于Roberta-ext-wwm的预训练模型-model_3_roberte_wwm_ext_att_drop_42,并生成测试集的预测概率文件
"""
...
patience = 5   # 早停轮数
file_name = 'model_3_roberta_wwm_ext'  # 指定输出文件的名字
model_name_or_path = './pretrain_weight/roberta_wwm_ext/'  # 预训练模型权重载入路径
